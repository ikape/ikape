<!-- Profile Header -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:007ACC,100:4F46E5&height=200&section=header&text=Ikape%20Isaac&fontSize=40&fontColor=ffffff&animation=twinkling" alt="header banner" />
</p>
...
![TypeORM](https://img.shields.io/badge/TypeORM-%233178C6.svg?style=flat&logo=typeorm&logoColor=white)
...
|--------------|-----------|----------------|
| **Value Payment Solutions** | Backend Engineer (2025–Present) | Built payment gateway integrations and microservices; improved observability and reliability using Docker and AWS. |
| **Africart Store Enterprise** | Mobile/Backend Developer (2024) | Built React Native apps integrated with Laravel APIs; enhanced UI and added push notifications with Expo. |
| **Codemanic Software Solutions** | Software Developer (2023–2024) | Delivered React + Node.js solutions; reduced bugs by 25% through better refactoring and testing. |
| **SOS Creativity (UK)** | Software Developer (2024) | Automated cloud deployment pipelines and improved CI/CD speed by 20%. |
| **Navigating with Neol (NGO)** | Full Stack Developer (Volunteer) | Built full-stack digital outreach platform; boosted performance by 15%. |
...
- 🛡️ **Secure Coding & Secure Application Development**  
- ☁️ **AWS Cloud Practitioner (In View)**  
